...
export const metadata: Metadata = {
	title: 'Sign Up',
	description: 'Sign up to Berlin, the AI app where you can convert images to code.',
}
	...
	return (
		<>
			<div className="w-3/5 h-full grid place-items-center ">
				<Image className="-rotate-45" src="/astronaut.webp" alt="astronaut" width={260} height={400} />
			</div>

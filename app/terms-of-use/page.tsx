	...
	return (
		<article className="p-20">
			...
			<p className="mt-6 text-neutral-200 text-lg">
				Welcome to Berlin AI! These Terms of Use outline the terms and conditions that govern your use of our artificial
				intelligence web application. By accessing or using our services, you agree to comply with and be bound by these
				terms.
			</p>
			...
			<p className="text-lg text-neutral-200 mb-4">
				By using Berlin AI, you agree to these Terms of Use. If you do not agree with any part of these terms, please do
				not use our services.
			</p>

			<h2 className="mt-14 mb-4 text-neutral-100 text-2xl font-semibold">2. User Registration</h2>
			<p className="text-lg text-neutral-200 mb-4">
				To access certain features of our AI web application, you may be required to register for an account. You agree
			...
			<p className="text-lg mb-4 text-neutral-200">
				...
				occur under your account. Notify us immediately of any unauthorized use of your account or any other breach of
				security.
			</p>

			<h2 className="mt-14 mb-4 text-neutral-100 text-2xl font-semibold">3. Freemium Service</h2>
			<p className="text-lg text-neutral-200 mb-4">
				Berlin AI offers a freemium service that provides users with 8 free credits per month. Additional credits may be
				available through paid subscription plans.
			</p>
			...
			<p className="text-lg text-neutral-200 mb-4">
				Berlin AI stores the code generations you create using our service for future access and usage. We make efforts
				to secure and protect your stored data, as outlined in our Privacy Policy.
			</p>
